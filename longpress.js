 ...
 * @license MIT
 */
// NOTE: modified to have a 500ms delay, long-press-up and to exclude #board
    ...
    function fireLongPressEvent(originalEvent) {
        ...
        if (suppressClickEvent) {
            ...
            document.addEventListener(mouseUp, function clearMouseUp(e) {
                ...
                cancelEvent(e);
                self.dispatchEvent(new CustomEvent('long-press-up', { bubbles: true, cancelable: true, detail: { clientX: clientX, clientY: clientY } }));
            }, true);
        }
    }
